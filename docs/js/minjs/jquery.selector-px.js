;(function($){
    ...
    $('body').append('<style>'+
                ...
                '.sel-box .btn{background:#3395FF;overflow:hidden;}'+
                ...
                '.sel-con .border{height:34px;border:solid 1px #95989F;border-width:1px 0;position:fixed;bottom:72px;left:0;right:0;pointer-events:none;}'+
                ...
                '.sel-con .ele{font-size:16px;color:#95989F;height:36px;line-height:36px;}'+
    ...
    $.scrEvent2 = function(params){
        ...
        $(evEle).attr('readonly','readonly');
        eleName!=''?eleName = '<div class="cell" style="font-size:14px;color:#95989F;">'+eleName+'</div>':eleName = '';
        eleName2!=''?eleName2 = '<div class="cell" style="font-size:14px;color:#95989F;">'+eleName2+'</div>':eleName2 = '';
